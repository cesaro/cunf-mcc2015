...
do_verif ()
{
	...
	do
		...
		if [ "$res" == "SAT" ]; then
			echo "FORMULA $id TRUE TECHNIQUES NET_UNFOLDING SAT_SMT SEQUENTIAL_PROCESSING"
		elif [ "$res" == "UNSAT" ]; then
			echo "FORMULA $id FALSE TECHNIQUES NET_UNFOLDING SAT_SMT SEQUENTIAL_PROCESSING"
		else
